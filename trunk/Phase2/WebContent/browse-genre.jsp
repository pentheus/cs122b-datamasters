		...
		<TD ALIGN="CENTER" BGCOLOR="#D3D4C5">
			<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0>
				<TR>
					...
					<TD HEIGHT=22 BGCOLOR="#D3D4C5" ALIGN=CENTER NOWRAP>&nbsp;&nbsp;Browse&nbsp;&nbsp;</TD>
					<TD BGCOLOR="#D3D4C5" ALIGN=CENTER>|</TD>
...
<TABLE WIDTH="50%">
<TR><TD>
	<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0"><TR BGCOLOR="#000000"><TD><IMG SRC="images/" WIDTH="1" HEIGHT="1" ALT=""></TD></TR></TABLE>
	<TABLE CELLSPACING="0" CELLPADDING="3" WIDTH="100%" BORDER="0" BGCOLOR="#D3D4C5">
		<TR>
		  <TD ALIGN="center"><FONT FACE="Lucida,Verdana,Helvetica,Arial">
		<B>Browse</B>
		</FONT></TD>
		</TR>
	</TABLE>
...
<TABLE WIDTH="50%" CELLPADDING="0" CELLSPACING="0" BORDER="0"><TR BGCOLOR="#000000"><TD><IMG SRC="images/1x1.gif" WIDTH="1" HEIGHT="1" ALT=""></TD></TR></TABLE>
	<TABLE CELLSPACING="0" CELLPADDING="3" WIDTH="50%" BORDER="0" BGCOLOR="#EEEED4">
		<TR><TD BGCOLOR="#EEEED4">
		<A HREF="browse-title.jsp"> Browse by Title </A></TD>
		</TR>
		<TR><TD BGCOLOR="#EEEED4"> Browse by Genre</TD>
		</TR>
	</TABLE>

<TABLE cellspacing="0" cellpadding="3" border="0" width="95%" bgcolor="ffec98">
	<TR>
...
<TR><TD>
	...
	<TABLE CELLSPACING="0" CELLPADDING="3" WIDTH="100%" BORDER="0" BGCOLOR="#D3D4C5">
		...
		<B><FONT SIZE="+2">Browse Results</FONT></B>
		</FONT></TD>
		</TR>
	</TABLE>
	<TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0"><TR BGCOLOR="#000000"><TD><IMG SRC="images/1x1.gif" WIDTH="1" HEIGHT="1" ALT=""></TD></TR></TABLE>
...
<A HREF="http://localhost:8080/Phase2/"></A><BR>
<P>
