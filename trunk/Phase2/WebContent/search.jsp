...
<TR><TD>
	...
	<table border="1">
		<tr>
			<td>Movie Title:</td>
			<td><input type="title" size="30"></td>
		</tr>
		<tr>
			<td>Year:</td>
			<td><input type="year" size="30"></td>
		</tr>
		<tr>
			<td>Director:</td>
			<td><input type="director" size="30"></td>
		</tr>
		<tr>
			<td>Star's Name: </td>
			<td><input type="star" size="30"></td>
		</tr>
	</table>
	<P><button type="Search">Search</button></P>
	</TABLE>
